...
# clean data
data <- data %>% mutate(V1 = as.POSIXct(dmy_hms(as.character(paste(V1, V2)))), V3 = as.numeric(as.character(V3)),
...
theLegend <- c("Sub_Metering_1", "Sub_Metering_2", "Sub_Metering_3")
legend("topright", lty=1, col = c("black", "red", "blue"),legend = theLegend)
